...
const OSearch = ({ intl: { formatMessage } }) => {
  ...
  // });
   ...
   const handleClick = e => {
    ...
    .then((data) => console.log('Our data', localStorage.setItem('stockname', data[0].symbol)))
     history.push("/dashboard/home");
    console.log(e)

    const apiUrlss = 'https://financialmodelingprep.com/api/v3/quote-short/'+e+'?apikey=83fc6708b362a8e7427cb5e740b358af'
    fetch(apiUrlss)
    .then((response) => response.json())
    .then((data) => console.log('Stock Price' + data, localStorage.setItem('stockprice', data.price)))
  };
