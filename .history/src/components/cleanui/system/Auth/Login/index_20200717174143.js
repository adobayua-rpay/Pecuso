  ...
  return (
    <div>
      <div className="text-center mb-5">
        ...
        <p>
          The best damn trading platform in the world.
          <br />
          You are now part of an elite few with the world in their hands.
          <br />
          Credentials for testing purposes - <strong>adobayua@gmail.com</strong> /{' '}
      ...
      <div className={`card ${style.container}`}>
        ...
        >
          ...
          <a href="/dashboard/alpha" className="text-center w-100" type="primary" size="large" loading={user.loading}>
            Add User
          </a>
        </Form>
      ...
      <div className="text-center pt-2 mb-auto">
        ...
        <Link to="/auth/starters" className="kit__utils__link font-size-16">
          Sign up
        </Link>
      </div>
    </div>
