...
import { Input,Slider,Form,Button,Link} from 'antd'
    ...
    <div>
      ...
      <div className="card card-solid bg-success">
        ...
        <div className="card-body"> 
          ...
          <button type="submit" className="btn btn-danger px-15" href="/auth/register" style={{marginLeft: '40%'}}>
            Lets do this!
          </button>
          <Link to="/auth/starters" className="kit__utils__link font-size-16">
            <Button renderAs="button">
              <strong>Lessgo!</strong>
            </Button>
          </Link>
