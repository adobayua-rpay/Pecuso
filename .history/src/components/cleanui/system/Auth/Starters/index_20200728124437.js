    ...
    <div>
      ...
      <div className="card card-solid bg-success">
        ...
        <div className="card-body"> 
          ...
          <button to="/dashboard/gamma" type="submit"  className="btn btn-danger px-15" href="/auth/register" style={{marginLeft: '40%'}}>
            Lets do this!
          </button>
          <Link to="/dashboard/gamma" className="kit__utils__link font-size-16">
