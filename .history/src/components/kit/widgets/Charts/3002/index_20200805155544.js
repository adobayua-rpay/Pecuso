    ...
    <div className="card-body overflow-hidden position-relative">
      <Tabs defaultActiveKey="1" onChange={callback}>
        <TabPane tab="Portfolio vs SPY" key="1">
          <iframe
            is="x-frame-bypass"
            src="https://api.stockdio.com/visualization/financial/charts/v1/Ticker?app-key=&symbols=AAPL;MSFT;GOOG;FB;ORCL;CRM;NVDA;TSLA;NEM;&palette=Financial-Light&layoutType=13&onload=st_c4e516600a964cbf845efb848e68ea21"
            title="viola"
            width="100%"
            position="absolute"
            height="1300"
        ...
        <TabPane tab="Portfolio Adjustments" key="4">
          <Form />
        </TabPane>
        <TabPane tab="Portfolio Charts" key="5">
          <Table dataSource={dataSourced} columns={expColumn} />
        </TabPane>
        <TabPane tab="Portfolio Projections" key="6">
          <Table dataSource={dataSourced} columns={expColumn} />
        </TabPane>
      </Tabs>
    </div>
