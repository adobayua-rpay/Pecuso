...
export default function RecipeReviewCard() {
  ...
  useEffect(() => {
    ...
    fetch(apiUrl)
      .then((res) => res.json())
      .then((repos) => {
        setAppState({ loading: false, repos: repos.financials, name:repos.companyName, sector:repos.sector, description:repos.description });
      });
  }, [setAppState]);


  const grossProf = repos.financials.grossProfit
