  ...
  return (
    <div className="card-body overflow-hidden position-relative">
      <Tabs defaultActiveKey="1" onChange={callback}>
        <TabPane tab="Stock Fundamental" key="1">
          <Fundamental />

        </TabPane>
        <TabPane tab="Key Stats" key="2">
          <Cha />
        ...
        <TabPane tab="Key Statts" key="7">
          <Key />
        </TabPane>
        <TabPane tab="Analyst Recommendations" key="3">
          <Analyst />
        </TabPane>
        ...
        <TabPane tab="Premium Data" key="6">
          <Table dataSource={dataSourced} columns={expColumn} />
        </TabPane>
      </Tabs>
    </div>
