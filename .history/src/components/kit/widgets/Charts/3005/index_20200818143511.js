  ...
  return (
    <div className="card-body overflow-hidden position-relative">
      <Tabs defaultActiveKey="1" onChange={callback}>
        ...
        <TabPane tab="Fund Ownership" key="7">
          <Ownership />
        </TabPane>
        <TabPane tab="Income Financials" key="8">
          <Income />
        </TabPane>
        <TabPane tab="Institutional Owenrship" key="3">
          <Analyst />
        </TabPane>
        <TabPane tab="Key Stats" key="4">
          <Form />
        </TabPane>
        <TabPane tab="Price Target" key="5">
          <Target />
        </TabPane>
        <TabPane tab="Corporate Actiosn" key="6">
