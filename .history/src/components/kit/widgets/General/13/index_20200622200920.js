    ...
    <div>
      ...
      >
        ...
        <div className="mt-auto mb-3">
          <div className="text-white font-size-24 font-weight-bold pl-4">Michal Magdziak</div>
        </div>
      </div>
      <div className="card card-borderless">
        <div className="card-header border-bottom-0">
          <div className="d-flex mb-1">
            <div className="text-dark text-uppercase font-weight-bold mr-auto">Portfolio Contribution YTD</div>
        ...
        <div className="card-body pt-1">
          Michal is contributing 23% to your portfolio performance.
        </div>
      </div>
    </div>
  )
