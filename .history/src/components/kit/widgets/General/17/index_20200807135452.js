...
const General17 = () => {
  return (
    <div>
      <div className="position-relative bg-success py-3 px-4 text-center" style={{ backgroundImage: `url(https://images.unsplash.com/photo-1587854692152-cbe660dbde88?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60)`}}>
