...
//import './index.css';
import { Drawer, Form, Button, Col, Row, Input, Select, DatePicker,Slider,Radio,Typography, Space } from 'antd';
              ...
              <Col span={12}>
                ...
                >
                  <Space direction="vertical">
                    <Text type="secondary">Please select an automatic trigger for this rule</Text>
                  </Space>
                  {/* <Input
                    style={{ width: '100%' }}
                    addonBefore="http://"
