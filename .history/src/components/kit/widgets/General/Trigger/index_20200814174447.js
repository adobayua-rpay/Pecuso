...
const marks = {
  ...
  function showVolume() {
    confirm({
      title: " What Is Average Volume? And how to use ",
      icon: <ExclamationCircleOutlined />,
          ...
          <Form layout="vertical" hideRequiredMark>
            ...
            >
              ...
              <Col span={52}>
                ...
                >
                  <Space direction="vertical">
                    <Text type="secondary">We will automatically act on this stock at a certain date based on a condition you pick</Text>
                  </Space>
                  <Space direction="vertical">
                    <DatePicker onChanges={onChanges} />
                  </Space>
                  <p></p>
                  ...
                  {/* <Input
                    ...
                    placeholder="We will alert you of price increase %"
                  /> */}
                          <Select placeholder="Please select your action trigger">
          <Option value="china">Buy : Price still the same</Option>
          <Option value="usa">Buy : Price Higher</Option>
          <Option value="usa">Buy : Price Lower</Option>
          <Option value="usa">Sell : Price still the same</Option>
          <Option value="usa">Sell : Price Higher</Option>
        </Select>
                  {/* <Radio.Group onChange = {this.onChange} value {...this.state.value}>
                    <Radio value ={1}> Buy Stock</Radio>
                    <Radio value ={2}> Sell Stock</Radio>
              ...
              onClick={showVolume}
            >
              Dont know anything about trading with volume? Click here to learn why and how
            </Button>
