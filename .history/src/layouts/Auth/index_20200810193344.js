        ...
        >
          ...
          >
            <div className={style.logoContainer}>
              <div className={style.logo}>
                ...
                {logo === 'Pecus' && <div className={style.descr}>Abysii / Pecus</div>}
              </div>
            </div>
          ...
          <div className="mt-auto pb-5 pt-5">
            ...
            <div className="text-center">
              Copyright ©2020 Abysii / Pecus |{' '}
              <a href="https://www.twitter.com/adoba" target="_blank" rel="noopener noreferrer">
                Adoba Yua
              </a>
            </div>
          </div>
