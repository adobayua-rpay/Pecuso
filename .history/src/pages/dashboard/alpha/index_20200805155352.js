    ...
    <div>
      ...
      <div className="row">
        <div className="col">
          <iframe
            is="x-frame-bypass"
            src="http://api.stockdio.com/visualization/financial/charts/v1/HistoricalPrices?app-key=7A455EB1CB88414CB37D2A847CC2053D&symbol=AAPL&days=365&width=800&height=420"
            title="viola"
            width="100%"
            position="absolute"
            height="1300"
