    ...
    <div>
      ...
      <div className="row">
        <div className="col">
          <iframe
            is="x-frame-bypass"
            src="https://api.stockdio.com/visualization/financial/charts/v1/Ticker?app-key=7A455EB1CB88414CB37D2A847CC2053D&symbols=AAPL;MSFT;GOOG;FB;ADTX;CVNA;BIGC;FRGI;CRM;NEM;NVDA;CELH;&palette=Financial-Light&layoutType=13&onload=st_ff2d12afdb2a4641bbf345f7f23fae96"
            title="viola"
            width="100%"
            position="absolute"
            height="65"
