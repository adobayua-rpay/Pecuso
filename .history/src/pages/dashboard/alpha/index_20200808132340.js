...
import DrawerForm from "components/kit/widgets/General/2000";
import Drawer from "pages/ui-kits/antd/examples/drawer"
  ...
  return (
    <div>
      ...
      <div className="cui__utils__heading mb-3">
        ...
        <Button onClick={<Drawed />}>Clear filters</Button>
        <Button onClick={Drawed}>Clear filters</Button>
        <Button onClick={handleClick}>
          Activate Lasers
        </Button>
        <Button onClick={Drawed}>
          Activate Lasers
        </Button>
        <handleClick />
        {/* <Drawed /> */}
