        ...
        <div className="col-lg-12 col-xl-6">
          <div className="card">
            <div className="card-header">
              ...
              <div className="text-muted">Adoba's account Information</div>
            </div>
          ...
          <div className="card">
            <div className="card-header">
              ...
              <div className="text-muted">Here is your account information and data.</div>
            </div>
            <div className="card-body">
              <div>
          ...
          <div className="card">
            <div className="card-header">
              ...
              <div className="text-muted">Adoba's friends.</div>
            </div>
            <div className="card-body">
              <div className="row">
