              ...
              <div className="mb-3">
                ...
                >
                  <Meta
                    ...
                    title="Kuo: Apple will not include earbuds or charger in iPhone 12 box, will introduce a 20W power adapter to be sold separately (Benjamin Mayo/9to5Mac)"
                    description="Benjamin Mayo / 9to5Mac : Kuo: Apple will not include earbuds or charger in iPhone 12 box, will introduce a 20W power adapter to be sold separately — Apple is set to be significantly slimming its packaging for its upcoming iPhone line. The analyst previously said that Apple will no longer include wired earbuds with the iPhone 12"
                  />
                </Card>
                <Card
                  style={{ width: 300 }}
