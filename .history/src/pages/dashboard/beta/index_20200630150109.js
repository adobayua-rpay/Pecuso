...
import { Slider, Calendar, Badge, Table, Dropdown, Button, Menu, Progress, Tabs, Avatar,Card } from 'antd'
    ...
    <div>
      ...
      <div className="row">
        <div className="col-lg-12 col-xl-6">
          ...
          <div className="card">
            <Card title="Premium Precision Alpha Price Dynamics">
              <CardSection
                expandable
              ...
              >
                <Stack direction="column" spacing="condensed">
                  <Text type="primary">omputed, machine learned Behavioral Energy measured from the equilibrium energy as zero offset. Positive: Bull, Negative: Bear. Measured in millivolts</Text>
            ...
            <div className="mb-3">
              ...
              <div className="mb-4 kit__utils__table">
                <Table columns={columna} dataSource={nix} onChange={this.handleChange} />
              </div>
            </div>
            </div>
        ...
        <div className="col-lg-12 col-xl-6">
          ...
          <div className="card">
            <Box bg="teal" fontFamily="futura" fontWeight="bold" w="100%" p={4} color="black">
              
              <Stat>
                <StatLabel>K-Score</StatLabel>
