        ...
        <div className={styles.content}>
          ...
          <div className="row mb-3">
            <div className="card .col-md1" style={{width: 300, marginLeft:50, backgroundColor:"#96ceb4"}}>
              <div className="fnt-size-36 font-weight-bold text-dark mb-n2" style={{ height: 45,marginLeft:50, }}>
                $3,186
              </div>
            ...
            <div className="card .col-md1" style={{width: 300, marginLeft:80, backgroundColor:"#ff6f69"}}>
              <div className="fnt-size-36 font-weight-bold text-dark mb-n2" style={{ height: 45, marginLeft:120, color:"#6e7f80" }}>
                -$86,081
              </div>
              <div className="text-upercase" style={{marginLeft:50,}}>
