        ...
        <div className={styles.content}>
          ...
          <div className="row mb-3">
            <div className="card mb-3" style={{width: 180, height:180, marginLeft:100, backgroundColor:"#00acee"}}>
              <Title level={4} style={{marginLeft:35,backgroundColor="#FFFFFF"}}>Twitter</Title>
            </div>
            <div className="card mb-3" style={{width: 180, height:180, marginLeft:100, backgroundColor:"#3b5998"}}>
              <Title level={4} style={{marginLeft:35,backgroundColor="#FFFFFF"}}>Facebook</Title>
            </div>
            <div className="card mb-3" style={{width: 180, height:180, marginLeft:100, backgroundColor:"#00acee"}}>
              <Title level={4} style={{marginLeft:35, backgroundColor="#FFFFFF"}}>News</Title>
            </div>
          </div>
