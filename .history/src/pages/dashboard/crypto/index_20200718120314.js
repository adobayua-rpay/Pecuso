    ...
    <div>
      ...
      <div className={styles.crypto}>
        ...
        <div className={styles.content}>
          ...
          <div className="row mb-3">
            <div className="card mb-3" style={{width: 320, height:180, marginLeft:100, backgroundColor:"#00acee"}}>
              <Title level={4} style={{marginLeft:45, color:'#fffbe6'}}>Twitter</Title>
            </div>
            <div className="card mb-3" style={{width: 320, height:180, marginLeft:100, backgroundColor:"#3b5998"}}>
              <Title level={4} style={{marginLeft:45, color:'#fffbe6'}}>Facebook</Title>
            </div>
            <div className="card mb-3" style={{width: 320, height:180, marginLeft:100, backgroundColor:"#00acee"}}>
              <Title level={4} style={{marginLeft:45, color:'#fffbe6'}}>News</Title>
            </div>
          </div>
