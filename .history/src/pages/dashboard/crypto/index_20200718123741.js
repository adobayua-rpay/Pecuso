      ...
      <div className={styles.crypto}>
        ...
        <div className={styles.content}>
          ...
          <div className="row mb-3" style={{backgroundColor:"#000000"}}>
            ...
            <div className="card mb-3" style={{width: 290, height:80, marginLeft:150, backgroundColor:"#00acee"}}>
              <Title level={4} style={{marginLeft:15, size:'5', color:'#fffbe6'}}>Twitter</Title>
              <UpCircleTwoTone twoToneColor="#01A690" style={{marginLeft:15, marginTop:5, width:40, fontSize:'32px'}} />
            </div>
