...
import { Spin, Alert, Table, Select, Tag, Radio, Input, Affix, Form, Rate,Modal,Button,Typography,Space  } from 'antd'
        ...
        <div className={styles.content}>
          ...
          <div className="row mb-3" style={{backgroundColor:"#000000"}}>
            ...
            <div className="card mb-3" style={{width: 290, height:80, marginLeft:50, backgroundColor:"#00acee"}}>
              ...
              <Text type="primary" style={{marginLeft:125, marginTop:-35, width:40, fontSize:'22px'}}>Ant Design</Text>
            </div>
