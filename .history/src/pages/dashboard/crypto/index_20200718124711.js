        ...
        <div className={styles.content}>
          ...
          <div className="row mb-3" style={{backgroundColor:"#000000"}}>
            ...
            <div className="card mb-3" style={{width: 290, height:80, marginLeft:50, backgroundColor:"#00acee"}}>
              ...
              <UpCircleTwoTone twoToneColor="#01A690" style={{marginLeft:255, marginTop:-35, width:40, fontSize:'22px'}} />
              <Text type="primary" style={{marginLeft:175, marginTop:-25,  fontSize:'15px'}}>2.86%</Text>
            </div>
