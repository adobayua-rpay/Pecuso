        ...
        <div className={styles.content}>
          ...
          <div className="row mb-3">
            ...
            <div className="card mb-3" style={{width: 290, height:80, marginLeft:50, backgroundColor:"#00acee"}}>
              ...
              <Text type="primary" style={{marginLeft:175, marginTop:-23,  fontSize:'15px', color:'#fffbe6'}}>Sentiment Score 2.86%</Text>
              <Text type="primary" style={{marginLeft:10, marginTop:5,  fontSize:'15px', color:'#fffbe6'}}>$37.98</Text>
            </div>
