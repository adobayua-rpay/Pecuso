...
const { Optioned, OptGroup } = Select;
...
const Formuno = () => {
  ...
  return (
    ...
    >
      ...
      <Form.Item name="pymnt" label="Payment Method">
      ...
      <Select defaultValue="lucy" style={{ width: 200 }} onChange={handleChange}>
        <OptGroup label="Manager">
          <Optioned value="jack">Jack</Optioned>
          <Optioned value="lucy">Lucy</Optioned>
        </OptGroup>
        <OptGroup label="Engineer">
          <Optioned value="Yiminghe">yiminghe</Optioned>
        </OptGroup>
        </Select>
