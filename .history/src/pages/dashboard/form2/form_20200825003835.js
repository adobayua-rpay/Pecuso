...
const Formuno = () => {
  ...
  let arrayHoldings = ['msft', 'nvda', 'amd', 'okta', 'alrm', 'syna', 'fb', 'cprt', 'odfl']
    ...
    const apiUrl0 = 'https://cloudiexapis.com/stable/stock/'+arrayHoldings[0]+'/price?token=pk_6c6a49f506644c7990b08fee0710a634'
    fetch(apiUrl0)
    .then((response) => response.json())
    .then((data) => console.log('Price0' + data[0].price, localStorage.setItem('price0', data[0].price)))

    const apiUrl1 = 'https://cloud.iexapis.com/stable/stock/'+arrayHoldings[1]+'/price?token=pk_6c6a49f506644c7990b08fee0710a634'
    fetch(apiUrl0)
    .then((response) => response.json())
    .then((data) => console.log('Price0' + data[0].price, localStorage.setItem('price0', data[1].price)))

    const apiUrl2 = 'https://cloud.iexapis.com/stable/stock/'+arrayHoldings[2]+'/price?token=pk_6c6a49f506644c7990b08fee0710a634'
    fetch(apiUrl2)
    .then((response) => response.json())
    .then((data) => console.log('Price0' + data[0].price, localStorage.setItem('price2', data[0].price)))

    const apiUrl3 = 'https://cloud.iexapis.com/stable/stock/'+arrayHoldings[3]+'/price?token=pk_6c6a49f506644c7990b08fee0710a634'
    fetch(apiUrl3)
    .then((response) => response.json())
    .then((data) => console.log('Price0' + data[0].price, localStorage.setItem('price3', data[0].price)))

    const apiUrl4 = 'https://cloud.iexapis.com/stable/stock/'+arrayHoldings[4]+'/price?token=pk_6c6a49f506644c7990b08fee0710a634'
    fetch(apiUrl3)
    .then((response) => response.json())
    .then((data) => console.log('Price0' + data[0].price, localStorage.setItem('price4', data[0].price)))

    const apiUrl5 = 'https://cloud.iexapis.com/stable/stock/'+arrayHoldings[5]+'/price?token=pk_6c6a49f506644c7990b08fee0710a634'
    fetch(apiUrl5)
    .then((response) => response.json())
    .then((data) => console.log('Price0' + data[0].price, localStorage.setItem('price5', data[5].price)))

    const apiUrl6 = 'https://cloud.iexapis.com/stable/stock/'+arrayHoldings[6]+'/price?token=pk_6c6a49f506644c7990b08fee0710a634'
    fetch(apiUrl6)
    .then((response) => response.json())
    .then((data) => console.log('Price0' + data[0].price, localStorage.setItem('price6', data[6].price)))

    const apiUrl7 = 'https://cloud.iexapis.com/stable/stock/'+arrayHoldings[7]+'/price?token=pk_6c6a49f506644c7990b08fee0710a634'
    fetch(apiUrl6)
    .then((response) => response.json())
    .then((data) => console.log('Price0' + data[0].price, localStorage.setItem('price7', data[7].price)))

    const apiUr8 = 'https://cloud.iexapis.com/stable/stock/'+arrayHoldings[8]+'/price?token=pk_6c6a49f506644c7990b08fee0710a634'
    fetch(apiUrl6)
    .then((response) => response.json())
