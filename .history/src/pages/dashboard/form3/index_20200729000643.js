...
const country = localStorage.setItem('country', values.country);
const tradeplatform = localStorage.setItem('tradeplatform', values.tradeplatform);
const investExperience = localStorage.setItem('investmentexperience', values.investmentexperience);
const broker = localStorage.setItem('broker', values.broker);
const income = localStorage.setItem('income', values.income);
