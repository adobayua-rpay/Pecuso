    ...
    <div>
      ...
      <div className="card card-solid bg-success">
        ...
        <div className="card-body"> Welcome
          <p>
            We are going to create an agent to trade for you first, he is really smart so trust him! His names Jim!

          </p>
          <button type="submit" className="btn btn-danger px-15" style={{marginLeft: '30%'}}>
            Lets do this
          </button>
        </div>
      </div>
