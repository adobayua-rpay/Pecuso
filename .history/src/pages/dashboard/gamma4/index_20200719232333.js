      ...
      <div className="row">
        <div className="row card-body">
          ...
          <div className="card-body" style={{ width: 900 }}>
            <Iframe
              url="https://api.stockdio.com/visualization/financial/charts/v1/HistoricalPrices?app-key=9570C608187A4630BAAD2492DC33BB7F&symbol=TSLAL&dividends=true&splits=true&palette=Financial-Light"
              id="myId"
