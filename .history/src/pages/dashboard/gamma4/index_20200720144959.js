    ...
    <div>
      ...
      <div className="row">
        <div className="row card-body">
          ...
          <div className="card border-0 bg-success text-white" style={{ width: 150, height:200 }}>
          ...
          <div className="card border-0 bg-warning text-white" style={{ width: 150, height:200 }}>
            <div className="card-body">
              <div className="d-flex flex-wrap align-items-center">
                <i className="fe fe-server font-size-50 mr-3" />
                <div>
