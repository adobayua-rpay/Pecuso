...
import {  CardSection,Stack } from "@kiwicom/orbit-components/";
...
const DashboardGamma2 = () => {
  ...
  return (
    <div>
      ...
      <div className="row">
        <div className="row card-body" style={{ width: wp('100%') }}>
          <Card
            hoverable   
            style={{ width: "150px" }}
            cover={<img alt="example" style={{ height: hp('100%') }} src="https://www.biography.com/.image/t_share/MTY2MzU3Nzk2OTM2MjMwNTkx/elon_musk_royal_society.jpg" />}
          >
