    ...
    <div>
      ...
      <div className="card">
        <div className="row">
          ...
          <div className="card-body" style={{ width: '20%', height:'15%' }}>
            <Iframe
              url="https://api.stockdio.com/visualization/financial/charts/v1/QuoteBoard?app-key=9570C608187A4630BAAD2492DC33BB7F&symbols=AAPL;MSFT;GOOG;FB;ORCL&includeLogo=false&includeCompany=false&includeChange=false&includeTrend=false&palette=Financial-Light&title=Watch%20List&onload=st_3a89f6d5f88b40d5bc8842aa66b9340c"
              id="myId"
              className="myClassname"
              display="initial"
              width="10%"
