        ...
        <div className="row">
          <div className="col" style={{ width:"100%"}}>
            <div className="row">
              <Card
                ...
                cover={<img alt="example" width='5' height="100" src="https://cdn2.iconfinder.com/data/icons/investing-crayons-vol-2/256/Volatility-512.png" />}
              >
                <Meta title="Volatility" description="1.98%" />
              </Card>
              <Card
                hoverable
                style={{ width:"30%"}}    
                cover={<img alt="example" width="5" height="100" src="https://cdn3.iconfinder.com/data/icons/data-science-15/64/19-512.png" />}
              >
          ...
          <div className="col">
            <Card
              hoverable
              style={{ width:"100%"}}    
              cover={<img alt="example" src="https://cdn1.iconfinder.com/data/icons/ringtone-music-instruments/512/beta-symbol-letter-greek-alphabet-2-512.png" />}
            >
              <Meta title="TSLA Beta" description="3.8" />
            </Card>
          </div>
          <div className="col">
            <Card
