      ...
      <div className="card">
        <div className="row">
          <div className="card-body" title="Quick Tools">
            <Space size={small}>
              <Button type="primary" style={{ marginLeft:"90%"}}>Stock Diagnostic</Button>
              <Button type="primary" style={{ marginLeft:"90%"}}>Price Prediction</Button>
              <Button type="primary" style={{ marginLeft:"90%"}}>Stock Volatility</Button>
            </Space>
