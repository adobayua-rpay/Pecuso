...
const addy = {};
addy.one = faker.address.streetAddress

const randomAddress2 = faker.address.streetAddress
const randomAddress3 = faker.address.streetAddress

const randomPrice = faker.finance.amount
const randomPrice2 = faker.finance.randomPrice
const randomPrice3 = faker.finance.randomPrice
