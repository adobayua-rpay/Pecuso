...
const datas = [
  {
    ...
    author: 'Michal Magdziak',
    avatar: 'https://zos.alipayobjects.com/rmsportal/ODTLcjxAfvqbxHnVXCYX.png',
    content: (
      <p>
        Anyone set a good price target on Tesla yet?
      </p>
    ),
    datetime: (
      <Tooltip
  ...
  return (
    <div>
      ...
      <div className="card">
        <div className="row">
          <div className="card-body" title="TSLA vs Competitors">
            ...
            <Iframe
              url="https://api.stockdio.com/visualization/financial/charts/v1/HistoricalPrices?app-key=9570C608187A4630BAAD2492DC33BB7F&indicators=BollingerBands(10,2.0);Stochastics(10,10);&symbol=TSLA&dividends=true&splits=true&palette=Financial-Light"
              id="myId"
              className="myClassname"
              display="initial"
              width="100%"
        ...
        <div className="row">
          <div className="card-body" title="Quick Tools">
            <Space size={small}>
              ...
              <Button type="primary">Anomaly Detection</Button>
              <Button type="primary">Trade Signals</Button>
      ...
      <div className="card">
        <div className="row">
          <div className="card-body" title="Quick Tools">
            <strong>Largest Tesla Trades Today</strong>
            <Table 
              columns={columns}
              dataSource={data} 
            />
        ...
        <div className="row">
          <div className="card-body" title="Quick Tools">
            ...
            <Space size={small}>
              ...
              <Button type="primary">Analyst Recommendations</Button>
              <Button type="primary">Estimates</Button>
              <Button type="primary">Key Stats</Button>
              <Button type="primary">Trade Signals</Button>
      ...
      <div className="card">
        <div className="row">
          <div className="card-body" title="Quick Tools">
            <Tabs type="card">
              <TabPane tab="Advanced Stats" key="1">
                <p>Content of Tab Pane 1</p>
                <p>Content of Tab Pane 1</p>
                <p>Content of Tab Pane 1</p>
              </TabPane>
              <TabPane tab="Analyst Recommendations" key="2">
                <p>Content of Tab Pane 1</p>
                <p>Content of Tab Pane 1</p>
                <p>Content of Tab Pane 1</p>
              </TabPane>
