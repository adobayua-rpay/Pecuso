...
export default function RecipeReviewCard() {
  ...
  const stock = localStorage.getItem('stocksearch');

  useEffect(() => {
    setAppState({ loading: true });
    const apiUrl = `https://cloud.iexapis.com/stable/stock/`+apiUrl+`/company?token=pk_6c6a49f506644c7990b08fee0710a634`;
    fetch(apiUrl)
      .then((res) => res.json())
