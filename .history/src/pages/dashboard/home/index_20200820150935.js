...
var serviceAccount = ("firebase-adminsdk-2fjqs@hose-stream.iam.gserviceaccount.com");

admin.initializeApp({
  credential: admin.credential.cert("firebase-adminsdk-2fjqs@hose-stream.iam.gserviceaccount.com"),
