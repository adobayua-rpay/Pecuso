...
{
  path: '/dashboard/gamma3',
  Component: lazy(() => import('pages/dashboard/gamma3')),
  exact: true,
},
              ...
              <SwitchTransition>
                ...
                >
                  <Switch location={location}>
                    <Route exact path="/" render={() => <Redirect to="/auth/starters" />} />
