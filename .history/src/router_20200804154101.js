...
const routes = [
  // Dashboards
  {
    path: '/dashboard/gammaAlgo2',
    Component: lazy(() => import('pages/dashboard/gamma2')),
    exact: true,
  },
  {
    path: '/dashboard/alphaAlgo',
    Component: lazy(() => import('pages/dashboard/alpha')),
    exact: true,
  },
  {
    path: '/dashboard/gamma4Algo',
    Component: lazy(() => import('pages/dashboard/gamma4')),
    exact: true,
  },
  {
    path: '/dashboard/betaAlgo',
    Component: lazy(() => import('pages/dashboard/beta')),
    exact: true,
  },
  {
    path: '/dashboard/portfoliointro',
    Component: lazy(() => import('pages/dashboard/portintro')),
    exact: true,
  },
  {
    path: '/dashboard/form3',
    Component: lazy(() => import('pages/dashboard/form3')),
    exact: true,
  },
  {
    path: '/dashboard/good',
    Component: lazy(() => import('pages/dashboard/good')),
    exact: true,
  },
  {
    path: '/dashboard/form1',
    Component: lazy(() => import('pages/dashboard/form1')),
    exact: true,
  },
  {
    path: '/dashboard/form2',
    Component: lazy(() => import('pages/dashboard/form2')),
    exact: true,
  },
  {
  ...
  {
    path: '/auth/starters',
    Component: lazy(() => import('pages/auth/starters')),
    exact: true,
  },
  {
    path: '/auth/stock',
    Component: lazy(() => import('pages/auth/stock')),
    exact: true,
  },
  {
    path: '/auth/register',
              ...
              <SwitchTransition>
                ...
                >
                  <Switch location={location}>
                    <Route exact path="/" render={() => <Redirect to="/dashboard/form1" />} />
