    ...
    <div>
      ...
      <ul className="list-unstyled">
        ...
        <li className={style.item}>
          <a className={style.itemLink}>
            <div className="kit__utils__avatar mr-3">
              <img src="https://842930.smushcdn.com/1760858/wp-content/uploads/2020/05/boom-13-technologies.png?lossy=1&strip=1&webp=1" alt="Jamie Rockstar" />
            </div>
            <div>
              <div className="text-blue">Tech Stocks</div>
