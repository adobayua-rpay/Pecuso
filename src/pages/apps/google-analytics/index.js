    ...
    <div>
      ...
      <div className="row">
        <div className="col-xl-8 col-lg-12">
          <h5 className="text-dark mb-4">Bollinger Bands</h5>
          <div className="card">
            <Chart2 />
          </div>
          <div className="row">
            <div className="col-lg-6">
              ...
              <h5 className="text-dark mb-4">How is this trigger fairing?</h5>
              <div className="card">
                <div className="card-body">
                  <Chart5 />
                </div>
            ...
            <div className="col-lg-6">
              ...
              <h5 className="text-dark mb-4">How are your active stocks trending over time?</h5>
              <div className="card">
                <div className="card-body">
                  <Chart1 />
                </div>
        ...
        <div className="col-xl-4 col-lg-12">
          ...
          <h5 className="text-dark mb-4">What are your top performing stocks with Bollinger?</h5>
          <div className="card">
            <div className="card-body">
              <List12 />
            </div>
