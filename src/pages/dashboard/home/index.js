...
import { Card, Form, Button,Modal,InputNumber,Checkbox,Input } from "antd";
...
const onFinish = (trim) => {
  console.log('hey')
  console.log("Received values of form: ", trim.stockcompare);
  console.log('poppin');
  console.log(trim)
};
...
const onNooled = e => {
  console.log(e);
      ...
      console.log('comparison is'+ comparisons)
...
console.log('test' + e)
  ...
  confirm({
    ...
    <strong>{stocksymbol}</strong> vs <strong> 
...
>
  ...
  <Form.Item
    ...
    rules={[
      {
        required: true,
        message: "Please put a stock name or symbol",
      },
    ]}
  >
    <Input />
    ...
    <strong>{stocksymbol}</strong> vs <strong> <Input defaultValue={"Amazon"} onChange={newComparison} /></strong>
    <Input placeholder="On Nooled" allowClear onChange={onNooled} />
